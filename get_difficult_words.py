def find_unsimilar_words(srt_file_l, lc_file_l):
    try:
        ...
        # Open and read the Longman Communication 3000 file/ we use this list of simple word
...
# for testing the code we use these files: (https://github.com/jnoodle/English-Vocabulary-Word-List/blob/master/Longman%20Communication%203000.txt)
