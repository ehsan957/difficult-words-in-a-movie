...
def get_word_meaning_from_longman(word):
    try:
        ...
        return None
# Add a delay of 1 second to avoid overloading the website with requests
import time
time.sleep(3)
...
lc_file_l = input('please enter longmman communication 3000 dictionary file path...')
...
for word in key_word:
    print(word)
# Print the unsimilar words with their meanings and write in a csv file
